...
- `hunyuanvideo1.5_1080p_sr_distilled_fp16.safetensors` (UNETLoader)
- `hunyuanvideo1.5_720p_i2v_fp16.safetensors` (UNETLoader)
- `hunyuanvideo15_vae_fp16.safetensors` (VAELoader)
